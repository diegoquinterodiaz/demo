...
$(document).ready(function(){
    ...
    jqGridAreas = jQuery("#tablaAreas").jqGrid({
        url:$("#base_url").val()+'admin/area/select',
        datatype: "json",
        mtype: 'POST',
        ...
        multiselect: false,
        ignoreCase: true,        
        editurl: $("#base_url").val()+'admin/area/editData',
    ...
    jqGridAreas.filterToolbar({
                stringResult:true,
                searchOnEnter:false,
                defaultSearch:"cn"
            });
    jqGridAreas.navGrid("#pTablaAreas", {        
        edit: true,
        add: true,
        del: false,
        view: true,
    ...
    // //Seccion de reglas en la eliminacion                
        beforeSubmit: function(postdata, formid) {            
            ...
            pos*/
            /*var id = jqGridAreas.jqGrid('getGridParam','selrow');
            var ret = jqGridAreas.jqGrid('getRowData',id);            
            postdata['oper']='del';
            postdata['activo']='1';
