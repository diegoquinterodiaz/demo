...
$(document).ready(function(){
    ...
    jqGridNivel = jQuery("#tablaNivel").jqGrid({
        url:$("#base_url").val()+'admin/nivel/select',
        datatype: "json",
        mtype: 'POST',
        colNames:['CODIGO','DESCRIPCION','OBSERVACION','ACTIVO'],
        colModel:[
        {
            name:'codigo',
            index:'codigo',
        ...
        multiselect: false,
        ignoreCase: true,        
        editurl: $("#base_url").val()+'admin/nivel/editData',
    ...
    jqGridNivel.filterToolbar({
                stringResult:true,
                searchOnEnter:false,
                defaultSearch:"cn"
            });
    jqGridNivel.navGrid("#pTablaNivel", {        
        edit: true,
        add: true,
        del: false,
        view: true,
    ...
    // //Seccion de reglas en la eliminacion                
        beforeSubmit: function(postdata, formid) {            
            ...
            pos*/
            /*var id = jqGridNivel.jqGrid('getGridParam','selrow');
            var ret = jqGridNivel.jqGrid('getRowData',id);            
            postdata['oper']='del';
            postdata['activo']='1';
