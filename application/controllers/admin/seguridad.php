	...
	class Seguridad extends CI_Controller
	{
		...
		public function index(){
			...
			if(isset($_SESSION['parametros'])){						
				...
				$this->load->view('admin/seguridad');
			}else{
				redirect();
			}
		}
		...
		public function select(){
			$this->load->model('Seguridad_model','obj',TRUE);
			$query=$this->obj->getSeguridad();	
